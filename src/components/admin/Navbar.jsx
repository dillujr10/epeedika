...
import { setSidebarOpen } from '../../app/redux/sidebarSlice';
  ...
  return (
    <>
     <div className="py-2 px-6 bg-white flex items-center shadow-md shadow-black/5 sticky top-0 left-0 z-30">
      <button onClick={()=> dispatch(setSidebarOpen(!sidebar.isSidebarOpen))} type="button" className="text-lg text-gray-600 sidebar-toggle">
