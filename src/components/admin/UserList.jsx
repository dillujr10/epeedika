    ...
    <>
      <div className="mx-auto h-[calc(100vh-48px)] overflow-y-auto w-screen-lg px-4 py-8 sm:px-8">
        <div className="flex items-center justify-between pb-6">
          <div>
            <h2 className="font-semibold text-gray-700 text-2xl">User Accounts</h2>
          ...
          <div className="flex items-center justify-between">
            <div className="ml-10 space-x-8 lg:ml-40">
              <button className="flex items-center gap-2 rounded-md bg-gray-900 px-4 py-2 text-sm font-semibold text-white focus:outline-none focus:ring hover:bg-blue-700">
                <svg
          ...
          <div className="overflow-x-auto">
            ...
            <thead className="sticky top-0">
                <tr className="bg-gray-900 text-left text-xs font-semibold uppercase tracking-widest text-white ">
                  ...
                  <th className="hidden md:table-cell px-5 py-3 ">User Role</th>
                  <th className="hidden md:table-cell px-5 py-3">Created at</th>
              ...
              <tbody className="text-gray-500    ">
                <tr>
                  ...
                  <td className="border-b border-gray-200 bg-white px-5 py-5 text-sm">
                    <button className="rounded-full bg-red-500 px-3 py-1 text-xs font-semibold text-green-900">
                      Delete
                    </button>
                  </td>
                </tr>
